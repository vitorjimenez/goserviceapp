...
public class ClienteController {
    ...
    public ModelAndView historico(Authentication authentication) {
        ...
        try{
            ...
            mv.addObject("errorMessage", "Erro ao carregar os agendamentos.");
        }
        return mv;
    }
    ...
    RedirectAttributes attributes){
        try{
            ...
            attributes.addFlashAttribute("successMessage", "Agendamento concluído");
                 ...
                 AgendamentoNaoEncontradoException |
                 StatusAgendamentoImutavelException ex){
            attributes.addFlashAttribute("successMessage", ex.getMessage());
        }catch (Exception ex){
            attributes.addFlashAttribute("successMessage", "Erro ao cancelar o agendamento");
        }
        return "redirect:/cliente/historico";
    }
