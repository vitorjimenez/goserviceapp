...
public class PrestadorController {
    ...
    public ModelAndView agenda(Authentication authentication){
        ...
        try {
            ...
            mv.addObject("errorMessage", "Erro ao encontrar dados do agendamento");
        }
    ...
    public String cancelarServico(
        ...
        try{
            ...
            attributes.addFlashAttribute("sucessMessage", "Agendamento cancelado.");
        } catch (AgendamentoNaoEncontradoException |
                 StatusAgendamentoImutavelException|
    ...
    public String confirmarAgendamento(
            @RequestParam(name = "agendamentoId")
            Long agendamentoId,
            Authentication authentication,
            RedirectAttributes attributes){
        try{
            agendamentoService.confirmAgenda(authentication, agendamentoId);
            attributes.addFlashAttribute("sucessMessage", "Agendamento confirmado.");
        } catch (AgendamentoNaoEncontradoException |
                 StatusAgendamentoImutavelException|
                 UsuarioNaoAutenticadoException    |
                 UsuarioNaoEncontradoException ex){
